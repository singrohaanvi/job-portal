            ...
            <div className="p-6">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-primary text-white font-medium rounded-lg hover:bg-primary/30 transition-colors"
                    >
