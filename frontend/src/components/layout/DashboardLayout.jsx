...
const DashboardLayout = ({activeMenu, children}) => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
        {/* SideBar */}
        <div 
            className={`fixed inset-y-0 left-0 z-50 transition-transform duration-300 transform group ${
                isMobile
                    ? sidebarOpen
                      ? "translate-x-0" 
                      : "-translate-x-full"
            ...
            <div className="flex items-center h-16 border-b border-gray-200 pl-6">
                {!sidebarCollapsed ? (
                    <Link className="flex items-center space-x-3" to='/'>
                        ...
                        <span className="text-gray-900 font-bold text-xl">CarrerConnect</span>
                    </Link>
                ) : (
