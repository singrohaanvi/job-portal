...
const SavedJobs = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-primary/20 to-secondary/20">
      <Navbar />
      <div className="conatiner mx-auto pt-24">
        {savedJobList && (
          <div className="bg-white p-6 rounded-lg">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4">
                <button
                  onClick={() => navigate(-1)}
                  className="group flex items-center space-x-2 px-3.5 py-3.5 text-sm font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-primary/50 to-secondary/50 border border-gray-200 hover:border-transparent rounded-xl transition-all duration-300 shadow-lg shadow-gray-100 hover:shadow-xl transform hover:-translate-y-0.5"
                >
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              {savedJobList.length === 0 ? (
                <div className="text-center py-16 lg:py-20 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/60">
                  ...
                  <p className="text-gray-600 mb-6">
                    Start saving jobs that are interest you to view them later.
                  </p>
                  <button
