              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  {jobDetails?.applicationStatus ? (
                    ...
                    <button
                      className="bg-gradient-to-r from-primary/50 to-primary/50 text-sm text-primary hover:text-white px-6 py-2.5 rounded-xl hover:from-primary/60 hover:to-secondary/60 transition-all duration-200 font-semibold transform hover:-translate-y-0.5"
                      onClick={applyToJob}
                    >
                      Apply Now
                    </button>
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-blue-50 text-sm text-blue-700 font-semibold rounded-full border border-blue-300">
                    {jobDetails.category}
                  </span>
                  <span className="px-4 py-2 bg-purple-50 text-sm text-purple-700 font-semibold rounded-full border border-purple-300">
                    {jobDetails.type}
                  </span>
